...
error_reporting(1);
$todel=$_GET['rno'];
mysqli_query("update doct SET dshow='N' where dno='$todel' ;");
$rs1=mysqli_query("SELECT * from doct where dshow='Y' order by
dname;");
$sno=1;
...
align=center>Options</td></tr>
<?php
$rs2=mysqli_query("SELECT * from doct where dshow='N' order by
dname;");
$sno=1;
