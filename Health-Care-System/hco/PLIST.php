...
Name</td><td align=center>Address</td><td align=center>Gender</td><td
align=center>Payment(E-Banking)</td>
</tr>
<?php


$rs1=mysqli_query("SELECT * from patient where pshow='Y' order by
pname;");
$sno=1;
...
align=center>Payment(E-Banking)</td></tr>
<?php
$rs2=mysqli_query("SELECT * from patient where pshow='N' order by
pname;");
$sno=1;
