...
<tr bgcolor=blue><td align=center><font SIZE=6 color=white>HEALTH CARE ORGANIZATION</font></td></tr>
...
{
$todel=$_GET['rno'];
mysqli_query("update appt SET ashow='N' where ano='$todel' ;");
}
$rs1=mysqli_query("SELECT * from appt where ashow='Y'");
$sno=1;
while( $row=mysqli_fetch_array($rs1)) {

$rs2=mysqli_query("SELECT pname from patient where pno='$row[2]'");
$rs3=mysqli_query("SELECT dname from doct where dno='$row[1]'");
...
align=center>Options</td></tr>
<?php
$rs1=mysqli_query("SELECT * from appt where ashow='N'");
$sno=1;
while( $row=mysqli_fetch_array($rs1)) {
